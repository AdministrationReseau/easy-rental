  ...
  return (
    <div>
      {isMobileView ? (
        <div>
          <button
            className="fixed bottom-4 right-4 bg-primary-blue text-white p-3 rounded-full shadow-lg z-50"
            ...
            <div className="flex justify-between text-sm">
              ...
              <span>Max: {followersRange[1]}</span>
                ...
                <div className="flex gap-2 mt-4">
                  <button
                    className="bg-primary-blue text-white p-2 rounded-lg flex-grow"
