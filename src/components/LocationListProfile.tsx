            ...
            <div className="grid grid-cols-1  gap-6">
                {locations.map((location, index) => (
                    ...
                    >
                        ...
                        <div className="flex justify-center items-center flex-row justify-around h-full w-[50%]">
                        ...
                        <div className="w-full justify-center items-center mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
