...
//     const [generatedActorId, setGeneratedActorId] = useState<string | null>(null);
//     const [showActorIdModal, setShowActorIdModal] = useState(false);
...
//             const actorId = 'ACTR-' + Math.random().toString(36).substring(2, 10).toUpperCase();
//             setGeneratedActorId(actorId);
//             setShowActorIdModal(true);
//         }
//         if (currentStep === 2) {
//             // Validate organization information
//             if (!formData.organizationName || !formData.organizationEmail || !formData.businessActorId) {
//                 setError("All required organization fields must be filled");
//                 return;
//             }
//         }
...
//                 <Head>
//                     <title>Organization Registration | Easy Rental</title>
//                 </Head>
...
//                             <p className="mt-2 text-sm md:text-base text-primary-100">Create your organization account in a few simple steps</p>
//                         </div>

//                         {/* Selected Plan Badge */}
//                         <div className="mt-4 flex justify-center">
//                             <div className="bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 inline-flex items-center space-x-2">
//                                 <span className="text-white font-medium">Selected Plan:</span>
...
//                                                     onMouseEnter={() => showTooltip("This username will be used to log in to your account")}
//                                                     onMouseLeave={hideTooltip}
//                                                 >
//                                                     <HelpCircle className="h-4 w-4" />
//                                                 </button>
//                                                 {tooltip === "This username will be used to log in to your account" && (
...
//                                                     type="button"
//                                                     className="absolute right-3 top-8 text-gray-400 hover:text-gray-500"
//                                                     onMouseEnter={() => showTooltip("Phone number in international format with country code")}
//                                                     onMouseLeave={hideTooltip}
//                                                 >
//                                                     <HelpCircle className="h-4 w-4" />
//                                                 </button>
//                                                 {tooltip === "Phone number in international format with country code" && (
//                                                     <div className="absolute right-0 mt-1 z-10 w-64 p-2 bg-black text-white text-xs rounded shadow-lg">
...
//                                                         type="button"
//                                                         className="absolute right-3 top-8 text-gray-400 hover:text-gray-500"
//                                                         onMouseEnter={() => showTooltip("Password must be at least 6 characters")}
//                                                         onMouseLeave={hideTooltip}
//                                                     >
//                                                         <HelpCircle className="h-4 w-4" />
//                                                     </button>
...
//                                                     You will be the main administrator of this organization. You can add other members after registration.
//                                                 </p>
//                                             </div>
//                                         </motion.div>
//                                     )}
...
//                                                     type="button"
//                                                     className="absolute right-3 top-8 text-gray-400 hover:text-gray-500"
//                                                     onMouseEnter={() => showTooltip("The official name of your organization or company")}
//                                                     onMouseLeave={hideTooltip}
//                                                 >
//                                                     <HelpCircle className="h-4 w-4" />
//                                                 </button>
//                                                 {tooltip === "The official name of your organization or company" && (
//                                                     <div className="absolute right-0 mt-1 z-10 w-64 p-2 bg-black text-white text-xs rounded shadow-lg">
//                                                         The official name of your organization or company
//                                                     </div>
//                                                 )}
//                                             </div>
...
//                                                     type="button"
//                                                     className="absolute right-3 top-8 text-gray-400 hover:text-gray-500"
//                                                     onMouseEnter={() => showTooltip("Unique identifier for your business issued by competent authorities")}
//                                                     onMouseLeave={hideTooltip}
//                                                 >
//                                                     <HelpCircle className="h-4 w-4" />
//                                                 </button>
//                                                 {tooltip === "Unique identifier for your business issued by competent authorities" && (
//                                                     <div className="absolute right-0 mt-1 z-10 w-64 p-2 bg-black text-white text-xs rounded shadow-lg">
//                                                         Unique identifier for your business issued by competent authorities
//                                                     </div>
//                                                 )}
//                                             </div>
...
//                                                     All provided information will be verified before full activation of your organization account.
//                                                 </p>
//                                             </div>
//                                         </motion.div>
//                                     )}
...
//                                                                 {new Intl.NumberFormat('en-US').format(getPlanPrice(selectedPlan))}
//                                                             </span>
//                                                             <span className="ml-1 text-lg text-gray-500 dark:text-gray-400">XAF</span>
//                                                             <span className="ml-2 text-sm text-gray-500 dark:text-gray-400">/ month</span>
//                                                         </div>
//                                                     </div>
...
//                                                     Payment is secure and encrypted. No banking information is stored on our servers.
//                                                 </p>
//                                             </div>
//                                         </motion.div>
//                                     )}
...
//                                                         <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
//                                                     </svg>
//                                                     A confirmation email has been sent to your address with your account details.
//                                                 </p>
//                                             </div>
...
//                     <div className="bg-white dark:bg-gray-900 p-6 rounded-lg max-w-md w-full relative shadow-lg">
//                     <button
//                         onClick={() => setShowActorIdModal(false)}
//                         className="absolute top-2 right-3 text-gray-400 hover:text-gray-600"
//                     >
//                         ✕
//                     </button>
//                     <h3 className="text-xl font-semibold text-primary-text dark:text-white mb-4 text-center">
//                         Your Business Actor ID
//                     </h3>
//                     <p className="text-sm text-gray-700 dark:text-gray-300 text-center mb-2">
//                         Use this ID for your next step in your subscription process in the system.
//                     </p>

//                     <div className="mt-4 mb-4 px-4 py-3 bg-whitish-background dark:bg-gray-800 border rounded-md flex items-center justify-between">
//                         <span className="font-mono text-green-text dark:text-green-400">{generatedActorId}</span>
//                         <button
//                         onClick={() => {
//                             navigator.clipboard.writeText(generatedActorId || '');
//                         }}
//                         className="ml-3 text-sm bg-primary-blue text-white px-3 py-1 rounded hover:bg-secondary-blue"
//                         >
//                         Copy
//                         </button>
//                     </div>
...
//                     <button
//                         onClick={() => {
//                         setShowActorIdModal(false);
//                         setCurrentStep(2); // passe à l'étape 2
//                         }}
//                         className="mt-4 w-full py-2 bg-primary-blue text-white rounded hover:bg-secondary-blue"
//                     >
//                         Continue
//                     </button>
//                     </div>
...
// src/app/(Organisation)/subscription/register/page.tsx
